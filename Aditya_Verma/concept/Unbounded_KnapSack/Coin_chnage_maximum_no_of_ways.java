...
public class Coin_chnage_maximum_no_of_ways implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Coin_chnage_maximum_no_of_ways(), "Main", 1 << 26).start();
	}

	/*
	 * Coin Change Problem Maximum Number of ways Given a value N, if we want to
	 * make change for N cents, and we have infinite supply of each of S = { S1, S2,
	 * .. , Sm} valued coins, how many ways can we make the change? The order of
	 * coins doesn’t matter. Example: for N = 4 and S = {1,2,3}, there are four
	...
	void solve() {
		...
		// when target will be 0 then there will be always answer
		for (int i = 0; i < n + 1; i++)
			dp[i][0] = 1;
		// when there is no coin in the array we can't get any desired target
