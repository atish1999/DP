...
public class Minimum_deletion_to_palindrome implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Minimum_deletion_to_palindrome(), "Main", 1 << 26).start();
	}
	
	/*
Minimum number of deletions to make a string palindrome
Given a string of size ‘n’. 
The task is to remove or delete 
minimum number of characters from the string 
...
we need to delete n-dp[n][m] no. of characters
because these number of characters are troubling the 
string to achieve palindrome
 */
	static int dp[][];
	...
	void solve() {
		...
		out.print("deleted characters are -> ");
