...
public class Longest_Increasing_Subsequence implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Longest_Increasing_Subsequence(), "Main", 1 << 26).start();
	}
	...
	void solve() {
		...
		if (n == 1) {
//		if we have one element in the array in that case lis would be 1
			out.print("1");
			return;
		}
		dp = new int[n];
