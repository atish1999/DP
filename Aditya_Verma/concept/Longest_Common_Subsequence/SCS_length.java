...
public class SCS_length implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new SCS_length(), "Main", 1 << 26).start();
	}
...
*/	
		out.print("length of shortest common super sequence:\n");
		out.print("->" + (n + m - dp[n][m]));
	}
