...
public class Minimum_insertion_to_palindrome implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Minimum_insertion_to_palindrome(), "Main", 1 << 26).start();
	}
/*
Minimum number of insertions to make a string palindrome
Given a string, find the minimum number of characters 
to be inserted to form Palindrome string out of given string
...
*/
	 ...
	 * as we are not allowed to replace the characters
	 * which are causing the whole string to become palindrome
	 * if we add those characters in opposite sides w.r.t
	 * their present position we will be able to convert
	 * the string into substring
	 * i.e. no. of characters to be inserted would be
	 * (n-dp[n][m])
	 */
	static int dp[][];
	void solve() {
