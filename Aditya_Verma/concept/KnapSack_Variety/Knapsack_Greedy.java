...
public class Knapsack_Greedy implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Knapsack_Greedy(), "Main", 1 << 26).start();
	}
	...
	void solve() {
		int n = fr.nextInt();
		W = fr.nextLong();
		a = fr.nextLongArray(n);

		limit = CP.ceil_div(W, 2);
		long val = 0;
