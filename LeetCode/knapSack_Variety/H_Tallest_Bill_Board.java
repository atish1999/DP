...
public class H_Tallest_Bill_Board implements Runnable {
	...
	//  static final FastReader fr = new FastReader("/home/atish/eclipse-workspace/Dynamic_Programming_DP/src/Aditya_Verma/concept/MCM/input.txt");
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new H_Tallest_Bill_Board(), "Main", 1 << 26).start();
	}
