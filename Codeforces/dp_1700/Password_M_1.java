...
public class Password_M_1 implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Password_M_1(), "Main", 1 << 26).start();
	}
	...
	void solve() {
		...
		out.print(max != 0 ? s.substring(0, max) : "Just a legend");
