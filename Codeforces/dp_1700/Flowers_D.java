...
public class Flowers_D implements Runnable {
...
//	static FastReader fr = new FastReader();
	...
	static FastReader fr = new FastReader("D://DP/src/Codeforces/dp_1700/dp1700.txt");

	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Flowers_D(), "Main", 1 << 26).start();
	}
	...
	int f(int n, int k) {
		...
		if (dp[n] != -1)
			return dp[n];
		return dp[n] = (f(n - 1, k) % mod + f(n - k, k) % mod) % mod;
